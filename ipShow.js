...
if (roomcom == 0) {
    ...
    $("#mes_wrap_box").prepend(`<button id="rentou_btn" type="button" class="btn"><img class="ic2w" width="25" height="25" src="https://yinkya.github.io/ip/IMG_0384.gif">連投</button>`);
    roomcom = 1;
}
